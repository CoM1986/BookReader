...
namespace BookReader.Model
{
    public class BaseModel
    {
        ...
        protected void RunAsync<TPredicateReturnType>(
            Func<TPredicateReturnType> predicateFunction,
            ...
            Action<Exception> exceptionAction) where TPredicateReturnType : IPredicateResult
        {
            ...
            _worker.RunWorkerCompleted +=
                (sender, args) => 
                {
                    ...
                    if (
                        args.Result != null 
                        && ((TPredicateReturnType) args.Result).Succes
                    )
                    {
